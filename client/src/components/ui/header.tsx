...
export default function Header() {
  ...
  return (
    <header className="w-full border-b border-gray-200 bg-white px-8 py-4 flex items-center justify-between">
      ...
      <nav className="flex items-center gap-6">
        ...
        <button className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white text-sm font-medium px-4 py-2 rounded-md">
